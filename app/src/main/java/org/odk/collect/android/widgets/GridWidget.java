        ...
        gridview.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (fieldName.equalsIgnoreCase("primarypump") ){
                    if (position==11){
                        PropertiesUtils.getPrimaryOther().setVisibility(VISIBLE);
                        PropertiesUtils.getQuestionPrimaryOther().setVisibility(VISIBLE);
                    }
                    else {
                        PropertiesUtils.getPrimaryOther().setVisibility(INVISIBLE);
                        PropertiesUtils.getQuestionPrimaryOther().setVisibility(INVISIBLE);
                    }
                }
